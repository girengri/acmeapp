...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO tbl_conductores VALUES (:cedula, :primernombre, :segundonombre, :primerapellido, :segundoapellido, :direccion, :telefono, :ciudad)");
